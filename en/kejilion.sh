...
add_connection() {
	...
	kj_ssh_read_host_user_port "Please enter IP address:" "请输入用户名 (默认: root): " "请输入端口号 (默认: 22): " "root" "22"
...
while true; do
	  ...
	  echo -e "${gl_kjlan}1.  ${gl_bai}添加服务器               ${gl_kjlan}2.  ${gl_bai}删除服务器            ${gl_kjlan}3.  ${gl_bai}Edit server"
